...
As for the **table_array** in the tooltip, highlight the whole table that contains the missing information.

![Step 3](./step-3.png)

### Step 4

As for the **col_index_num**, the column **"ID number"** is in column B.
